...
> Python client SDK for interacting with the core inference API - part of the [ComputeHaven](https://github.com/ComputeHaven) open-source ecosystem.
...
The `sdk` package provides the Python interface for integrating with ComputeHaven's infrastructure, designed for ease of use in both scripts and production services.
...
```bash
git clone https://github.com/ComputeHaven/sdk
cd sdk
pip install -e .
```
